...
const Navbar = () => {
    ...
    {/* <button type="button" onMouseEnter={() => setSee(true)}
        onMouseLeave={() => setSee(false)} class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collaps">
  ...
  return (
    ...
    <div   className="row">
            <div className="innercol col-md-4 col-xs-12 col-sm-6">
                <div data-aos="fade-up" class="col col2">
                    <img src="7175EHtzjhL._SL1500_.jpg"/>
                </div>
            </div>
            <div className="innercol col-md-4 col-xs-12 col-sm-6">
                <div data-aos="fade-right" className="col col2">
                  <img src="7175EHtzjhL._SL1500_.jpg"/>
                </div>
            </div>
            <div className="innercol col-md-4 col-xs-12 col-sm-6">
                <div data-aos="fade-left" className="col col2">
                  <img src="7175EHtzjhL._SL1500_.jpg"/>
                </div>
            </div>
            <div className="innercol col-md-4 col-xs-12 col-sm-6">
  ...
  return (
           <div id ="contacticon" className="footer">
             ...
             <form data-aos="zoom-in" className="form">
                 ...
                 <button data-aos="zoom-in" className = "btn btn-foot">Book an appointment</button>
               </form>
  ...
  return (
    ...
    <div className="row">
            <div className="innercol col-md-6 col-xs-6 col-sm-6">
                <div data-aos="fade-right"class=" info col col2">
                <h3>Say Hello</h3>
            ...
            <div className="innercol col-md-6 col-xs-6 col-sm-6">
                <div data-aos="fade-left" className=" info col col2">
                  <h3>Opening Hours</h3>
